package com.fathersprophets.backend.services.chat.anonymouschatmessage
...
interface IAnonymousChatMessageService {
    ...
    fun createMessage(request: CreateAnonymousChatMessageRequest, lang: String): ApiResponse<Int>
    fun updateMessage(id: Int?, request: UpdateAnonymousChatMessageRequest, lang: String): ApiResponse<Nothing>
