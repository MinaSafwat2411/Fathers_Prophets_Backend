...
class PersonStoryQuestionDao : CrudDao<PersonStoryQuestionDto, PersonStoryQuestionCreateDto, PersonStoryQuestionUpdateDto> {
    ...
    override fun create(dto: PersonStoryQuestionCreateDto) = transaction {
    ...
    override fun update(id: Int, dto: PersonStoryQuestionUpdateDto) = transaction {
