...
object AttendanceTable : Table("attendance") {
    ...
    val sessionId = reference("session_id", SessionTable.id, onDelete = ReferenceOption.CASCADE)
    ...
    val classId = reference("class_id", ClassesTable.id, onDelete = ReferenceOption.CASCADE)
