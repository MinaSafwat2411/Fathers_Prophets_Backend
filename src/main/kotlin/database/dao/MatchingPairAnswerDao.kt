...
class MatchingPairAnswerDao {
    ...
    fun findByPairIdAndUserId(pairId: Int, userId: Int) = transaction {
    ...
    fun delete(dto: MatchingPairAnswerDto) = transaction {
        MatchingPairAnswersTable.deleteWhere { MatchingPairAnswersTable.id eq dto.id } > 0
    }
}