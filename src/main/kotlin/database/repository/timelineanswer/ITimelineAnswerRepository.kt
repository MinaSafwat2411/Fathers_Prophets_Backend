...
interface ITimelineAnswerRepository {
    ...
    fun updateAnswer(id: Int, request: UpdateTimelineAnswerRequest, lang: String): ApiResponse<TimelineAnswerResponse>
    fun updateAnswerStatus(id: Int, request: UpdateTimelineAnswerStatusRequest, lang: String): ApiResponse<TimelineAnswerResponse>
