...
class VersionRepository(
    ...
    override fun getLastVersion(lang: String): ApiResponse<VersionResponse> {
    ...
    override fun getPinByVersion(adminPinRequest: AdminPinRequest, lang: String): ApiResponse<Nothing> {
